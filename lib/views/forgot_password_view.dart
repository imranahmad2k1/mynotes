...
import 'package:mynotes_practiceproject/utilities/dialogs/password_reset_email_sent_dialog.dart';
        ...
        if (state is AuthStateForgotPassword) {
          if (state.hasSentEmail) {
            ...
            await showErrorDialog(
              context,
              "We could not process your request. Please make sure you're a registered user, or go back one step to register new user.",
            );
          }
        }
      },
